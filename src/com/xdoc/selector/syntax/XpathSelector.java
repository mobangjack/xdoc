 ...
 *
 */
public class XpathSelector extends SyntaxSelector {
	...
	public static Elements select(String xpath,Elements elements) {
		return new XpathSelector(xpath).select(elements);
	}
